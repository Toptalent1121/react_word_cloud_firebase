        ...
        return (
            <div>
                    ...
                    <CardContent>
                        {
                            (this.state.imageUrl)?
                                ((this.state.imageUrl == 'READY')?
                                    'Loading Word Cloud Image...':
                                    ((this.state.imageUrl == 'NONE')?
                                        'Create a word cloud for the text.':
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label="Max Length" type="number" name="maxCount" value={this.state.maxCount} onChange={this.handleValueChange} /><br/>
                        <TextField label="Min Length" type="number" name="minLength" value={this.state.minLength} onChange={this.handleValueChange} /><br/>
                    </DialogContent>
                    <DialogActions>
                        <Button variant="contained" color="primary" onClick={this.handleSubmit}>
                            {(this.state.imageUrl == 'NONE')? 'Create': 'Again'}
                        </Button>
